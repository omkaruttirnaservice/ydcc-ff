...
const { momentDates, getMerchTxnId } = require("../../config/_responderSet.js");
const {
	ONLINE_PAYMENT,
	SUCCESS_PAYMENT_MSG,
	FAILED_PAYMENT_MSG,
...
const req_enc_key = "4661080E5B49B02A737EBC2E1D72F72D";
const req_salt = "4661080E5B49B02A737EBC2E1D72F72D";
const res_dec_key = "473D462E1D987CCE8EF4A19731F7B0EF";
const res_salt = "473D462E1D987CCE8EF4A19731F7B0EF";
const resHashKey = "90f5ce763867091ae7";
const reqHashKey = "6ec8f846caa58a5a5c";

const merchId = "628871";
const merchPass = "84709463";
const prodId = "SAHAKARI";
...
const atomPgController = {
	getPaymentDetails: (reqe, resp, next) => {
		try {
		...
		try {
			...
			axios
				...
				.then(result => {
					...
					let responseDetails =
						_response.payInstrument[0].responseDetails;

					const payStatusCode = responseDetails.statusCode;
					...
					const insertData = {
						pay_status_code:
							responseDetails.statusCode == "OTS0000" || "OTS0002"
								? SUCCESS_PAYMENT_CODE
								: FAILED_PAYMENT_CODE,
						pay_message:
