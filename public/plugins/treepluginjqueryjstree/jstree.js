...
(function (factory) {
	 ...
	 */
	/*!
	 * if using jslint allow for the jQuery global and use following options:
	...
	$.jstree.core.prototype = {
		...
		/**
		 * set the text value of a node. Used internally, use `rename_node(obj, val)`.
		 * @private
