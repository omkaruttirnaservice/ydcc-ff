 ...
 *
 * For details refer to: http://www.datatables.net
 */
...
(function (factory) {
	 ...
	 * full list of features refer to
	...
	var DataTable = function (options) {
		...
		/**
		 * Add a single new row or multiple rows of data to the table. note
	...
	DataTable.defaults = {
		 ...
		 * you can override using this option. refer to the jQuery
		 ...
		 * column options that can be set, see
		 ...
		 * default filtering input box and retain filtering abilities, use
		 ...
		 *
		 *  @deprecated 1.10. use `ajax` for this functionality now.
		 */
		fnServerData: null,
		...
		oLanguage: {
			 ...
			 * initialiser object (i.e. the above parameters). refer to one of
	...
	DataTable.ext = _ext = {
		 ...
		 *
		 * note that you should not need to use the internal methods for
